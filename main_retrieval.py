...
bot = b.ChatBot(vector_db_path = "data\\eng_script_vectorized_v3.pkl",
              context_len = 5, 
              similarity_type = 'retrieval', 
              vectorization_type = 'sent_encode',
              character = 'Leonard',
              rerank_param = ('cross_enc', 5, "model\\crerankingeval-30e-4000-ms-marco-MiniLM-L-6-v2"),
              verbose=0 )
...
def handle_response(text: str) -> str:
    ...
    elif processed == bot.session_stop_word:
